      ...
      <div className="card relative">
        ...
        <div className="text-center mb-12 space-y-4">
          <p className="text-lg text-neutral-300">
            You are a few steps away from completing the setup of NoisePort
            Server. This server is meant to run on a dedicated machine, such as
            a Raspberry Pi or a home server, to make your music accessible
            anytime and anywhere. If you don't have a dedicated machine,
            consider setting up a virtual machine on a cloud provider like
            DigitalOcean, Hetzner or OVH.
          </p>
          <p className="text-neutral-400">
            If you encounter any issues, you can always contact me directly on
            the NoisePort Discord server. You can revisit this wizard anytime to
