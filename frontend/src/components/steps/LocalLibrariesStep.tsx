...
export default function LocalLibrariesStep({
  config,
  onUpdate,
  onValidation,
  testConnection,
}: Props) {
  const [navidromeStatus, setNavidromeStatus] = useState<
  ...
  return (
    <>
      ...
      <Text c="dimmed" mb="xl">
        Connect to your local music libraries for enhanced metadata and
        organization. These services work together to provide a complete music
        streaming and management experience.
      </Text>
      ...
      <Alert color="blue" variant="light" mb="xl">
        ...
        <List size="sm">
          <List.Item>
            Click the service links above to open each web interface
          </List.Item>
          <List.Item>
            Create user accounts in Navidrome and Jellyfin to access your
            library
          </List.Item>
          <List.Item>
            Configure authentication below to enable wizard integration
          </List.Item>
          <List.Item>
            Use slskd to download new music that will appear in your libraries
          </List.Item>
        </List>
      </Alert>
      ...
      <Paper p="md" mb="md" withBorder>
        <Checkbox
          ...
          onChange={(event) =>
            handleNavidromeToggle(event.currentTarget.checked)
          }
          mb="md"
        />
        ...
        <Collapse in={config.navidrome.enabled}>
          <TextInput
            ...
            onChange={(event) =>
              handleNavidromeChange("url", event.currentTarget.value)
            }
            mb="md"
            required
          />
          ...
          <Group grow mb="md">
            <TextInput
              ...
              onChange={(event) =>
                handleNavidromeChange("username", event.currentTarget.value)
              }
              required
            />
            <PasswordInput
              ...
              onChange={(event) =>
                handleNavidromeChange("password", event.currentTarget.value)
              }
              required
            />
          </Group>
      ...
      <Paper p="md" withBorder>
        <Checkbox
          ...
          onChange={(event) =>
            handleJellyfinToggle(event.currentTarget.checked)
          }
          mb="md"
        />
        ...
        <Collapse in={config.jellyfin.enabled}>
          <TextInput
            ...
            onChange={(event) =>
              handleJellyfinChange("url", event.currentTarget.value)
            }
            mb="md"
            required
          />
          ...
          <Group grow mb="md">
            <TextInput
              ...
              onChange={(event) =>
                handleJellyfinChange("username", event.currentTarget.value)
              }
              required
            />
            <PasswordInput
              ...
              onChange={(event) =>
                handleJellyfinChange("password", event.currentTarget.value)
              }
              required
            />
          </Group>
