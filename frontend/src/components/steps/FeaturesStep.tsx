...
export default function FeaturesStep({
  ...
  useEffect(() => {
    // Only validate if scrobbling is enabled and credentials are present
    const isValid =
  ...
  return (
    <>
      <h2 className="text-2xl font-kode mb-4">Additional Features</h2>
      <p className="text-neutral-400 mb-6">
        Configure optional features for enhanced functionality. Scrobbling
        allows you to track your listening history and send data to Last.fm for
        music discovery and statistics.
      </p>
        ...
        <div className="space-y-4">
          <div>
            <Checkbox
              ...
              onChange={(event) =>
                handleScrobblingToggle(event.currentTarget.checked)
              }
            />
          ...
          {config.features.scrobbling && (
            <div className="ml-8 space-y-4">
              <TextInput
                ...
                onChange={(event) =>
                  handleLastfmApiKeyChange(event.currentTarget.value)
                }
                required
              ...
              <PasswordInput
                ...
                onChange={(event) =>
                  handleLastfmSecretChange(event.currentTarget.value)
                }
                required
          ...
          {restartSuccess && (
            ...
            >
              Navidrome container restarted successfully with new Last.fm
              credentials!
            </Alert>
          )}
        </div>
