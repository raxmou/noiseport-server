...
export default function SpotifyStep({ config, onUpdate, onValidation }: Props) {
  ...
  useEffect(() => {
    // Only validate if Spotify is enabled and credentials are present
    const isValid =
  ...
  return (
    <>
      <h2 className="text-2xl font-kode mb-4">Spotify API Configuration</h2>
      <p className="text-neutral-400 mb-4">
        Connect to Spotify to enhance music discovery and metadata enrichment.
        Don't worry, you don't need a premium account to use the API. We only
        require basic API access for fetching track and artist information.
      </p>
        ...
        {config.spotify.enabled && (
          <div className="space-y-4">
            <TextInput
              ...
              onChange={(event) =>
                handleSpotifyChange("clientId", event.currentTarget.value)
              }
              required
            ...
            <PasswordInput
              ...
              onChange={(event) =>
                handleSpotifyChange("clientSecret", event.currentTarget.value)
              }
              required
            ...
            {restartSuccess && (
              ...
              >
                FastAPI container restarted successfully with new Spotify
                credentials!
              </Alert>
            )}
            ...
            >
              <div className="text-sm">
                ...
                <ol className="list-decimal ml-5 mt-2 space-y-1">
                  ...
                  <li>
                    Add http://localhost:8000/callback to your app's redirect
                    URIs
                  </li>
                </ol>
              </div>
