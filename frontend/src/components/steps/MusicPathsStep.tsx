        ...
        <Alert variant="info" className="mb-4">
          <div className="text-sm space-y-2">
            <p>
              ...
              If you do so, make sure the drive is properly mounted and accessible by the system before proceeding.
            </p>
            <p className="mt-2">
              <strong>📁 Directory Structure:</strong><br/>
              • <code className="bg-neutral-800 px-1 rounded">{config.musicPaths?.hostMusicPath || './music'}/downloads/</code> - For files being downloaded<br/>
              • <code className="bg-neutral-800 px-1 rounded">{config.musicPaths?.hostMusicPath || './music'}/complete/</code> - For your organized music library
            </p>
          </div>
        </Alert>
        <TextInput
      ...
      {configSaved && (
        <Alert variant="info" className="mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="font-semibold text-blue-200">Configuration Saved!</p>
              <p className="text-sm text-neutral-400">Configuration files correctly generated, ready to launch services!</p>
            </div>
          </div>
        </Alert>
      )}
        ...
        {servicesLaunched && serviceStatus && (
          <Paper className="bg-green-900/20 border-green-700/30 mt-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <p className="font-semibold text-green-200 text-lg">🎉 Services Launched Successfully!</p>
                <p className="text-sm text-neutral-400">All services are running with your configured music path. Time to set up your accounts!</p>
              </div>
            </div>
              ...
              {Object.entries(serviceStatus).map(([serviceName, service]: [string, ServiceStatus], index) => {
                ...
                return (
                  <div key={serviceName}>
                    ...
                    />
                    {!isLastService && <hr className="border-neutral-700 my-6" />}
                  </div>
                );
              })}
            </div>
