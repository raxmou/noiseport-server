...
def test_upload_album():
    ...
    files = [
        ("files", ("01 - Test Song 1.mp3", create_fake_audio_file("01 - Test Song 1.mp3"), "audio/mpeg")),
        ("files", ("02 - Test Song 2.mp3", create_fake_audio_file("02 - Test Song 2.mp3"), "audio/mpeg")),
        ("files", ("03 - Test Song 3.mp3", create_fake_audio_file("03 - Test Song 3.mp3"), "audio/mpeg")),
    ]
